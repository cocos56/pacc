...
SELECT Job_N, role, `hosts`, version, user_name, pay_pw, coins, buy, last_buy_coins, confirm FROM idle_fish WHERE Job_N LIKE 'ABA%' and coins >= 40000 and `hosts` LIKE 'C5:%'
